...
// // Magazine publication Routes
// export const getAllRecordsMagazine = `${BASE_URL}/teacher/magazine-pb/all`;
// export const getOneRecordsMagazine = (username) => {
//   return `${BASE_URL}/teacher/magazine-pb/${username}`;
// };
// export const addRecordsMagazine = `${BASE_URL}/teacher/magazine-pb/create-new`;
// export const deleteRecordsMagazine = `${BASE_URL}/teacher/magazine-pb/remove`;
// export const updateRecordsMagazine = `${BASE_URL}/teacher/magazine-pb/update`;
// export const uploadRecordsMagazine = `${BASE_URL}/teacher/magazine-pb/upload-file`;
