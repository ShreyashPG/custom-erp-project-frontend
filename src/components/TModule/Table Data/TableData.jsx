...
export default function TableData({ tableName }) {
  ...
  const getApiRoute = (tableName) => {
    ...
    const apiRoutes = {
      ...
      // "Magazine Publication": (username) => getOneRecordsMagazine(username),
  ...
  const deleteAPIRoute = (tableName) => {
    const deleteRoutes = {
      // "Magazine Publication": (username, T_ID) =>
      //   `${deleteRecordsMagazine}?username=${username}&T_ID=${T_ID}`,
  ...
  const updateAPIRoute = (tableName) => {
    const updateRoutes = {
      // "Magazine Publication": (username, T_ID) =>
      //   `${updateRecordsMagazine}?username=${username}&T_ID=${T_ID}`,
      "Book Publication": (username, T_ID) =>
