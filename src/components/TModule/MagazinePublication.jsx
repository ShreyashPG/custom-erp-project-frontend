...
// import { addRecordsMagazine, uploadRecordsMagazine } from "./API_Routes";

// export default function MagazinePublication() {
...
//       queryParams.append("tableName", "magazine_publication");
...
//       const url = `${uploadRecordsMagazine}?${queryParams.toString()}`;
...
//       // Send a POST request to the addRecordsMagazine API endpoint
//       await axios.post(addRecordsMagazine, formDataWithFilePath);
